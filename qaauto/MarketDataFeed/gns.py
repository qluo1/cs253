...
##boost
#BOOST_BASE  = "/gns/mw/cpe/tww/gs-tww-libboost-1.55.0-1rhel6"
#BOOST_INC   = os.path.join(BOOST_BASE,"include")
#BOOST_LIB   = os.path.join(BOOST_BASE,"lib64")
##python
...
## jsoncpp
##jsoncpp-0.6.0_rc2-2-20150512
#JSON_BASE   = os.path.join(GNS,"jsoncpp.opt-0.6.0rc2_2")
#JSON_BASE   = os.path.join(GNS,"jsoncpp-0.6.0_rc2-2-20150512")
...
ORBIX       = "/gns/mw/lang/c/iona-orbix_dev-run-6.3-01-GS1/6.3-01-GS1/asp/6.3"
ORBIX_LIB   = os.path.join(ORBIX,"lib","lib64")

#BOOST_GNS = "/gns/mw/lang/c/boost-1.41-0-25"
